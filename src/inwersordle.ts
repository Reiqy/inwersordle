...
class Random {
    ...
    private getInitialSeed(): string {
        ...
        const today = new Date(current.getUTCFullYear(), current.getUTCMonth(), current.getUTCDate())
        const ticks = today.getTime();
        return ticks.toString();
    }

    private getSeeder(seed: string): () => number {
    ...
    private getGenerator(seed: number): () => number {
        return function() {
